    ...
    else
    {
        ...
        for (int i = 0; i < fire_count; i++)
        {
            for (int j = 0; j < enemy_count; j++)
            {
                ...
                if ((bullet_X_arr[i] >= UFO_1_X_pos[j] - 20 && bullet_X_arr[i] <= UFO_1_X_pos[i] + UFO_1_X2_pos + 10 && bullet_Y_arr[i] <= UFO_1_Y_pos[j] && bullet_Y_arr[i] >= UFO_1_Y_pos[j] - 1) || (bullet_2_X_arr[i] >= UFO_1_X_pos[j] - 20 && bullet_2_X_arr[i] <= UFO_1_X_pos[i] + UFO_1_X2_pos + 10 && bullet_2_Y_arr[i] <= UFO_1_Y_pos[j] && bullet_2_Y_arr[i] >= UFO_1_Y_pos[j] - 1))
                {
                    clash_count++;
                    fire_count--;
                    enemy_count--;
